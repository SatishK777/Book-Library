...
function Add() {
    ...
    return (
        <>
            {/* Form */}
            <Container className="pt-5 mt-5" id="bg">
                ...
                <section className="pb-5 position-static" >
                    <Form className='form-wrapper boxshadow' onSubmit={handleSubmit}>
                        ...
                        {/* title */}
                        <h1 className="title bg-dark text-center mb-5">ADD Book Data</h1>

                        {/* row-1 */}
                        <Form.Group className="mb-3 d-flex align-items-center">
                            <Form.Label className="w-3 text-black">Book Title</Form.Label>
                        ...
                        {/* submit */}
                        <Button className="btn-submit d-flex mt-4 mx-auto bg-dark" type="submit">
                            Add
                        </Button>
                    </Form>
                </section>
