...
function Home() {
    ...
    return (
        <div>
            ...
            <div className="table-wrapper boxshadow pt-5 ">
               
                <section className="tableFixHead">
                <h1 className="text-white bg-dark text-center p-2">View Book Data</h1>
                                ...
                                books.map((row) => (
                                    <tr key={row.id}>
                                        ...
                                        <td className="d-flex justify-content-center flex-nowrap align-content-center align-items-center my-auto gap-2">
                                            {/* Button Update */}
                                            <Button className="btn btn-update bg-dark" onClick={() => handleUpdate(row.id)}>
                                                <FontAwesomeIcon icon={faPenToSquare} />
                                            </Button>

                                            {/* Button - Delete */}
                                            <Button className="btn btn-delete bg-dark">
